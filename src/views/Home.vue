  ...
  <div class="home">
    <v-container data-app style="padding:0 2.5vw;margin-top: 74px;max-width:97vw;">
      <v-row>
        ...
        <dCard col="3" icon img="factura" text="Facturaciones." :title="invoices" :loading="loading[1]"/>
      ...
      <v-row>
        ...
        <dCard col="4" icon img="payment" title="Ventas" hoverable/>
...
export default {
  ...
  async beforeMount(){
    await this.createBasics();
    await this.createGroupsRank();
    await this.createStorageValue();
  }
};
</script>
